...
def run_system_monolith():
    ...
    while True:
        ...
        if opt == "1": #Added == to made opt equals to 1
            ...
            rem = input("Name to remove: ").title() #First letter is capatalised.
            ...
            for rank in r:
                if rank == "Captain" or rank == "Commander": #Assigned and made commander equals to rank.
                    count = count + 1
            print("High ranking officers: " + str(count)) #Addded str(x) to convert count from interger to string.
...
run_system_monolith() #Missing Brackets.